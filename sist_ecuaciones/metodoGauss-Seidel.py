...
# Metodo que implementa el metodo de Gauss-Seidel
# A matriz de nxn
# b vector del sistema Ax = b
# X aproximacion inicial

def hazGaussSeidel(A,b,X,iteraciones,epsilon):
	x_anterior = X
	n = size(A[0])
	x_nueva = zeros([n])
	num = 0
...
itera = 10000
epsilon = 0.000000001
print "\nSolución con Gauss-Seidel ","Maximas iteraciones: ",str(itera)," epsilon: ",str(epsilon)
print hazGaussSeidel(A,B,[0]*len(B),itera,epsilon)
print "\nSolución con NUMPY: "
